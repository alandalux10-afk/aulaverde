...
function generarHtmlFactura(venta, lineas, configuracion) {
...
<body>
  ...
  <table>
    <thead>
      <tr>
        <th>Nº</th><th>Código</th><th>Descripción</th>
...
function imprimirFactura(venta, lineas, configuracion) {
  return new Promise((resolve, reject) => {
    try {
      const html = generarHtmlFactura(venta, lineas, configuracion)
...
module.exports = { imprimirFactura, generarHtmlFactura }
